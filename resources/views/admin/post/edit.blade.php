                    ...
                    <form action="{{ route('post.update',$edit->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="title_en" value="{{ $edit->title_en }}" class="form-control @error('title_en') is-invalid @enderror">
                                @error('title_en')
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="title_bn" value="{{ $edit->title_bn }}" class="form-control @error('title_bn') is-invalid @enderror">
                                @error('title_bn')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <select name="category" class="form-control @error('category') is-invalid @enderror">
                                    ...
                                    @foreach ($category as $iteam)
                                        @if ($iteam->id == $edit->cate_id)
                                        <option value="{{ $iteam->id }}" selected>{{ $iteam->category_bn }}</option>
                                        @else
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select id="subCategory" name="SubCategory" class="form-control @error('SubCategory') is-invalid @enderror">
                                    <option value="{{ $edit->subcategory->id }}">{{ $edit->subcategory->subCategory_bn }}</option>
                                </select>
                                @error('SubCategory')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select id="subDist" name="SubDistrics" class="form-control @error('SubDistrics') is-invalid @enderror">
                                    @if ($iteam->subdist_id !='')
                                    <option value="">{{ $iteam->subdistric->subDis_bn }}</option>
                                    @endif
                        ...
                        <div class="mt-3">
                            ...
                            <img src="{{ asset('storage/'.$edit->image) }}" style="height:80px;width:100px">
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6 mt-3">
                                ...
                                <input id="tags" type="text" name="tags_en" value="{{ $edit->tags_en }}" class="form-control @error('tags_en') is-invalid @enderror" data-role="tagsinput">
                                @error('tags_en')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="form-group col-md-6 mt-3">
                                ...
                                <input id="tags" type="text" name="tags_bn" value="{{ $edit->tags_bn }}" class="form-control @error('tags_bn') is-invalid @enderror" data-role="tagsinput">
                                @error('tags_bn')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="form-group mt-3">
                          ...
                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ $edit->desc_en }}</textarea>
                        </div>
                        ...
                        <div class="form-group mt-3">
                          ...
                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ $edit->desc_bn }}</textarea>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    @if ($edit->headline == 'on')
                                    <input type="checkbox" name="headline" id="" checked>
                                ...
                                <div class="form-group">
                                    @if ($edit->first_section == 'on')
                                    <input type="checkbox" name="firstSection" id="" checked>
                            ...
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    @if ($edit->first_sec_thumbnail == 'on')
                                    <input type="checkbox" name="firstSectionThumb" id="" checked>
                                ...
                                <div class="form-group">
                                    @if ($edit->big_thumbnail == 'on')
                                    <input type="checkbox" name="firstSectionBigThumb" id="" checked>
                                    <label for="">First Section Thumbnail</label>
                                    @else
